      ...
      <div className="mx-auto max-w-4xl">
        <header className="hodam-glass-card mb-6 p-6 sm:p-8">
          ...
          <p className="mt-2 text-sm text-[#5f6670] sm:text-base">
            개인정보 수집, 이용, 보관 및 보호 조치에 대한 정책을 안내합니다.
          </p>
        </header>
          ...
          <div className="space-y-8 text-gray-700">
            <section>
              ...
              <p className="leading-relaxed mb-4">
                호담(HODAM)은 다음의 목적을 위하여 개인정보를 처리합니다.
                처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지
                않으며, 이용 목적이 변경되는 경우에는 개인정보보호법 제18조에
              ...
              <div className="space-y-2">
                ...
                <p>
                  3) 고객 지원: 고객 문의 응답, 서비스 개선을 위한 의견 수렴
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-2">
                ...
                <div className="ml-4 space-y-1">
                  <p>1) 필수항목: 이메일 주소</p>
                  <p>
                    2) 자동 수집 항목: 서비스 이용 기록, 접속 로그, 쿠키, 접속
                    IP 정보
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <div className="space-y-2">
                <p>
                  회사는 정보주체의 개인정보를 개인정보의 처리목적에서 명시한
