...
export default function PrivacyPage() {
  return (
    <LegalPageLayout
      ...
      footer={
        <LegalContactFooter
          effectiveDateText="본 개인정보처리방침은 2024년 1월 1일부터 시행됩니다."
          contactPrefixText="개인정보 관련 문의사항이 있으시면"
        />
      }
    >
      <LegalSection title="1. 개인정보의 처리목적">
        ...
        <div className="space-y-2">
          <p>
            1) 회원 가입 및 관리: 회원 식별, 서비스 이용에 따른 본인확인, 개인
            식별, 불량회원의 부정 이용 방지와 비인가 사용 방지
          </p>
          <p>
            2) 서비스 제공: AI 동화 생성 서비스, 번역 서비스, 이미지 생성 서비스
            제공
          </p>
      ...
      <LegalSection title="2. 개인정보의 처리 및 보유기간">
        <div className="space-y-2">
          <p>
      ...
      <LegalSection title="3. 처리하는 개인정보의 항목">
        <div className="space-y-2">
          <p>회사는 다음의 개인정보 항목을 처리하고 있습니다:</p>
          <div className="ml-4 space-y-1">
            <p>1) 필수항목: 이메일 주소</p>
            <p>
              2) 자동 수집 항목: 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보
            </p>
          </div>
        </div>
      </LegalSection>
      ...
      <LegalSection title="5. 개인정보처리의 위탁">
        <div className="space-y-2">
          <p>
          ...
          <div className="ml-4 space-y-2">
            ...
            <div className="ml-4">
              ...
              <p>- 위탁하는 업무의 내용: 데이터베이스 관리 및 서버 호스팅</p>
            </div>
            <p>2) AI 서비스 제공업체</p>
            <div className="ml-4">
              <p>- 위탁받는 자: OpenAI</p>
      ...
      <LegalSection title="6. 정보주체의 권리·의무 및 행사방법">
        <div className="space-y-2">
          <p>
      ...
      <LegalSection title="7. 개인정보의 안전성 확보조치">
        <div className="space-y-2">
          <p>
      ...
      <LegalSection title="8. 개인정보보호책임자">
        <div className="space-y-2">
          <p>
      ...
      <LegalSection title="9. 개인정보 처리방침 변경">
      ...
      <LegalSection title="10. 쿠키의 운영 및 거부">
        <div className="space-y-2">
          <p>
