    ...
    >
      <LegalSection title="제1조 (목적)">
        <p className="leading-relaxed">
          이 약관은 호담(HODAM, 이하 &ldquo;회사&rdquo;)이 제공하는 AI 동화 생성
      ...
      <LegalSection title="제2조 (정의)">
        <div className="space-y-2">
          <p>
            1. &ldquo;서비스&rdquo;란 회사가 제공하는 AI 기반 동화 생성 및 관련
            서비스를 의미합니다.
          </p>
          <p>
            2. &ldquo;이용자&rdquo;란 이 약관에 따라 회사가 제공하는 서비스를
            받는 회원 및 비회원을 말합니다.
          </p>
          <p>
            3. &ldquo;회원&rdquo;이란 회사에 개인정보를 제공하여 회원등록을 한
            자로서, 회사의 정보를 지속적으로 제공받으며 회사가 제공하는 서비스를
            계속적으로 이용할 수 있는 자를 말합니다.
          </p>
          <p>
            4. &ldquo;곶감&rdquo;이란 서비스 이용을 위한 가상의 결제 수단을
            의미합니다.
          </p>
        </div>
      </LegalSection>
      ...
      <LegalSection title="제5조 (서비스 이용료)">
        <div className="space-y-2">
          <p>
            1. 서비스 이용은 곶감을 통해 이루어지며, 곶감의 가격 및 이용료는
            회사가 정합니다.
          </p>
          <p>
            2. 현재 베타 서비스 기간 중에는 회원가입 시 무료 곶감이 제공됩니다.
          </p>
      ...
      <LegalSection title="제7조 (저작권의 귀속 및 이용제한)">
        <div className="space-y-2">
          <p>
            1. 회사가 작성한 저작물에 대한 저작권 기타 지적재산권은 회사에
            귀속합니다.
          </p>
          <p>2. 서비스를 통해 생성된 동화의 저작권은 이용자에게 귀속됩니다.</p>
          <p>
            3. 이용자는 서비스를 이용함으로써 얻은 정보 중 회사에게 지적재산권이
      ...
      <LegalSection title="제8조 (개인정보보호)">
        <p className="leading-relaxed">
          회사는 이용자의 개인정보를 보호하기 위해 개인정보처리방침을 수립하고
          이를 준수합니다. 자세한 내용은 개인정보처리방침을 참조하시기 바랍니다.
        </p>
      </LegalSection>
      ...
      <LegalSection title="제9조 (면책조항)">
        <div className="space-y-2">
          ...
          <p>
            3. 회사는 AI가 생성한 동화의 내용에 대해 완전한 보장을 하지 않으며,
            생성된 콘텐츠의 적절성에 대한 최종 판단은 이용자의 책임입니다.
          </p>
        </div>
      </LegalSection>

      <LegalSection title="제10조 (분쟁해결)">
        <div className="space-y-2">
          <p>
