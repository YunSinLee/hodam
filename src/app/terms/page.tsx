    ...
    <div className="hodam-page-shell px-4 pb-16 pt-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        <header className="hodam-glass-card mb-6 p-6 sm:p-8">
          ...
          <h1 className="hodam-heading mt-2 text-3xl text-[#2f3338] sm:text-4xl">
            이용약관
          </h1>
          <p className="mt-2 text-sm text-[#5f6670] sm:text-base">
            호담 서비스 이용과 관련된 주요 권리 및 의무 사항을 안내합니다.
          </p>
        </header>

        <article className="rounded-3xl border border-[#ef8d3d]/20 bg-white/92 p-6 shadow-[0_18px_40px_rgba(181,94,23,0.1)] sm:p-8">
          <div className="space-y-8 text-gray-700">
            <section>
              ...
              <p className="leading-relaxed">
                이 약관은 호담(HODAM, 이하 &ldquo;회사&rdquo;)이 제공하는 AI
                동화 생성 서비스(이하 &ldquo;서비스&rdquo;)의 이용과 관련하여
            ...
            <section>
              ...
              <div className="space-y-2">
                <p>
                  1. &ldquo;서비스&rdquo;란 회사가 제공하는 AI 기반 동화 생성 및
                  관련 서비스를 의미합니다.
                </p>
                <p>
                  2. &ldquo;이용자&rdquo;란 이 약관에 따라 회사가 제공하는
                  서비스를 받는 회원 및 비회원을 말합니다.
                </p>
                <p>
                  3. &ldquo;회원&rdquo;이란 회사에 개인정보를 제공하여
                  회원등록을 한 자로서, 회사의 정보를 지속적으로 제공받으며
                  회사가 제공하는 서비스를 계속적으로 이용할 수 있는 자를
                  말합니다.
                </p>
                <p>
                  4. &ldquo;곶감&rdquo;이란 서비스 이용을 위한 가상의 결제
                  수단을 의미합니다.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-2">
                ...
                <p>
                  2. 회사는 서비스의 품질 향상을 위해 서비스의 내용을 변경할 수
                  있습니다.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-2">
                <p>
                  1. 서비스 이용은 곶감을 통해 이루어지며, 곶감의 가격 및
                  이용료는 회사가 정합니다.
                </p>
                <p>
                  2. 현재 베타 서비스 기간 중에는 회원가입 시 무료 곶감이
                  제공됩니다.
                </p>
                <p>3. 정식 서비스 출시 시 이용료 정책이 변경될 수 있습니다.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-2">
                ...
                <p>
                  2. 서비스를 통해 생성된 동화의 저작권은 이용자에게 귀속됩니다.
                </p>
                <p>
                  3. 이용자는 서비스를 이용함으로써 얻은 정보 중 회사에게
            ...
            <section>
              ...
              <p className="leading-relaxed">
                ...
                수립하고 이를 준수합니다. 자세한 내용은 개인정보처리방침을
                참조하시기 바랍니다.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-2">
                ...
                <p>
                  2. 회사는 이용자의 귀책사유로 인한 서비스 이용의 장애에
                  대하여는 책임을 지지 않습니다.
                </p>
                <p>
                  3. 회사는 AI가 생성한 동화의 내용에 대해 완전한 보장을 하지
                  않으며, 생성된 콘텐츠의 적절성에 대한 최종 판단은 이용자의
                  책임입니다.
                </p>
              </div>
            </section>
          ...
          <div className="mt-12 border-t border-[#f0deca] pt-8">
