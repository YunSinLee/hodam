        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-8 animate-fade-in">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full group relative overflow-hidden bg-[#FEE500] hover:bg-[#FFEB3B] rounded-2xl px-6 py-4 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg"
            >
            ...
            <button
              ...
              className="w-full group relative overflow-hidden bg-white hover:bg-gray-50 border-2 border-gray-200 hover:border-gray-300 rounded-2xl px-6 py-4 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg"
            >
              <div className="flex items-center justify-center relative z-10">
                <img
